...
import { DEFAULT_TRANSCRIPTION_LANGUAGE } from "@/lib/languages.util";
...
export const DEFAULT_TRIGGER_KEY = `${MODIFIER_TRIGGER_PREFIX}right-command`;
/** Registered alongside modifier-hold triggers as an alternate shortcut. */
