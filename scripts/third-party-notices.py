...
def collect():
    # Include the union of dependencies shipped in both universal-app slices.
    by_id = {}
    for target in ("aarch64-apple-darwin", "x86_64-apple-darwin"):
        ...
        by_id.update((p["id"], p) for p in metadata["packages"] if p["id"] in resolved and p["name"] != "linty")
